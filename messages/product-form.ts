export const productForm = {
    dialog: { title: "Dodaj nowy produkt", description: "Formularz dodawania produktu w trzech krokach", close: "Zamknij" },
    steps: {
    ...
    fields: {
        ...
        description: { label: "Opis produktu", placeholder: "Krótki opis produktu" },
    ...
    errors: {
        name: { required: "Podaj nazwę produktu", tooShort: "Nazwa musi mieć minimum 3 znaki" },
        sku: {
            required: "Podaj SKU produktu", pattern: "SKU może zawierać tylko litery i cyfry",
            tooLong: "SKU może mieć maksymalnie 24 znaki", duplicate: "Produkt o tym SKU już istnieje"
        },
        ...
        priceNet: { required: "Podaj cenę netto", positive: "Cena musi być większa od zera" },
        vatRate: { required: "Wybierz stawkę VAT" },
        currency: { required: "Wybierz walutę" },
        stockQuantity: {
            required: "Podaj ilość na magazynie", integer: "Podaj liczbę całkowitą",
            negative: "Ilość nie może być ujemna"
        },
        minPerCart: { integer: "Podaj liczbę całkowitą", tooHigh: "Minimalna ilość nie może być większa niż maksymalna" },
        maxPerCart: { integer: "Podaj liczbę całkowitą", tooLow: "Maksymalna ilość nie może być mniejsza niż minimalna" },
    },
} as const
