export const productForm = {
    ...
    errors: {
        ...
        priceGross: { required: "Podaj cenę brutto", positive: "Cena musi być większa od zera" },
        ...
        minPerCart: {
            required: "Podaj minimalną ilość", integer: "Podaj liczbę całkowitą",
            min: "Minimalna ilość musi wynosić co najmniej 1",
            tooHigh: "Minimalna ilość nie może być większa niż maksymalna"
        },
        maxPerCart: {
            required: "Podaj maksymalną ilość", integer: "Podaj liczbę całkowitą",
